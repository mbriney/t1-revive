...
>   from before Linux, and its Touch Bar panel stays dark in macOS Recovery too, with Apple's
>   own stack driving it. That one predates the tool.
...
> was confirmed by a tester on a 13,3 (issue #4), not by us; four machines.
